...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--generate_from_audio_only',default=True, action='store_true', help='if specified, generate only from audio features')
        parser.add_argument('--noise_pose', default=True, action='store_true', help='noise pose to generate a talking face')
        parser.add_argument('--style_feature_loss',default=True, action='store_true', help='style_feature_loss')
        ...
        parser.add_argument('--input_id_feature',default=True, action='store_true', help='if specified, use id feature as style gan input')
