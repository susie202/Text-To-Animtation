...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--meta_path_vox', type=str, default='./misc/demo2.csv', help='the meta data path')
        parser.add_argument('--driving_pose',  default=True, action='store_true', help='driven pose to generate a talking face')
        ...
        parser.add_argument('--gen_video', default=True, action='store_true', help='whether to generate videos')
