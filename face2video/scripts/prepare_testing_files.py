...
if __name__ == "__main__":
    ...
    parser.add_argument('--dir_path', default='./misc',
                        help="dst file position")
    parser.add_argument('--src_pose_path', default='./misc/Pose_Source/731200067.mp4',
                        help="pose source file position, this could be an mp4 or a folder")
    parser.add_argument('--src_audio_path', default='./misc/Audio_Source/demo_voice.mp3',
    ...
    parser.add_argument('--src_input_path', default='./misc/Input/daeho_happy',
